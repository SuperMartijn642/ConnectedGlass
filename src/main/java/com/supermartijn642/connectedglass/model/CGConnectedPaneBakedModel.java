...
public class CGConnectedPaneBakedModel extends CGConnectedBakedModel {
    ...
    @Nonnull
    @Override
    public IModelData getModelData(@Nonnull ILightReader level, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull IModelData tileData){
    ...
    protected BakedQuad remapQuad(BakedQuad quad, CGModelData modelData){
        ...
        // Create a new quad
        return new BakedQuad(vertexData, quad.getTintIndex(), quadDirection, quad.getSprite(), quad.shouldApplyDiffuseLighting());
    }
