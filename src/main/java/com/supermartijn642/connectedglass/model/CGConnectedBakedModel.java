...
public class CGConnectedBakedModel extends CGBakedModel {
    ...
    public CGConnectedBakedModel(BakedModel original){
        super(original);
    }

    @Override
    public @Nonnull ModelData getModelData(@Nonnull BlockAndTintGetter level, @Nonnull BlockPos pos, @Nonnull BlockState state, @Nonnull ModelData tileData){
        return ModelData.builder().with(CGModelData.MODEL_PROPERTY, CGModelData.create(level, pos, state)).build();
    }
