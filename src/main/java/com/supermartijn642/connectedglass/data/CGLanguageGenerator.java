    ...
    public void generate(){
        ...
        for(CGGlassType type : CGGlassType.values()){
            ...
            for(EnumDyeColor color : EnumDyeColor.values()){
                this.block(type.getBlock(color), type.translation + " " + TextComponents.translation("item.fireworksCharge." + color.getUnlocalizedName()).format() + " Stained Glass");
                if(type.hasPanes)
                    this.block(type.getPane(color), type.translation + " " + TextComponents.translation("item.fireworksCharge." + color.getUnlocalizedName()).format() + " Stained Glass Pane");
            }
        }
    }
}
