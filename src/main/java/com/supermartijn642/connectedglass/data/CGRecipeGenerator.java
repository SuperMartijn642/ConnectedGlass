...
public class CGRecipeGenerator extends RecipeGenerator {
    ...
    public void generate(){
        ...
        this.shaped("vanilla_" + Registries.BLOCKS.getIdentifier(ConnectedGlass.tinted_glass).getPath(), ConnectedGlass.tinted_glass, 4)
            .pattern("AA")
            .pattern("AA")
            .input('A', previous)
            .unlockedBy(previous);
        ...
        this.shaped(ConnectedGlass.tinted_glass)
            .pattern(" A ")
            .pattern("BCB")
            .pattern(" A ")
            .input('A', Tags.Items.GEMS_QUARTZ)
            .input('B', Tags.Items.DYES_BLACK)
            .input('C', Tags.Items.GLASS)
            .unlockedBy(Tags.Items.GLASS);
    }
