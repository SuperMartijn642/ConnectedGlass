...
public class CGTagGenerator extends TagGenerator {
    ...
    private static final Tag.Named<Block>[] COLORED_GLASS_BLOCK_TAGS = new Tag.Named[]{
    ...
    @SuppressWarnings("unchecked")
    private static final Tag.Named<Block>[] COLORED_PANE_BLOCK_TAGS = new Tag.Named[]{
    ...
    @SuppressWarnings("unchecked")
    private static final Tag.Named<Item>[] COLORED_GLASS_ITEM_TAGS = new Tag.Named[]{
    ...
    @SuppressWarnings("unchecked")
    private static final Tag.Named<Item>[] COLORED_PANE_ITEM_TAGS = new Tag.Named[]{
