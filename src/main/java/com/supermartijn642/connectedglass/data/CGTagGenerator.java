...
public class CGTagGenerator extends TagGenerator {
    ...
    private static final ITag.INamedTag<Block>[] COLORED_GLASS_BLOCK_TAGS = new ITag.INamedTag[]{
    ...
    @SuppressWarnings("unchecked")
    private static final ITag.INamedTag<Block>[] COLORED_PANE_BLOCK_TAGS = new ITag.INamedTag[]{
    ...
    @SuppressWarnings("unchecked")
    private static final ITag.INamedTag<Item>[] COLORED_GLASS_ITEM_TAGS = new ITag.INamedTag[]{
    ...
    @SuppressWarnings("unchecked")
    private static final ITag.INamedTag<Item>[] COLORED_PANE_ITEM_TAGS = new ITag.INamedTag[]{
